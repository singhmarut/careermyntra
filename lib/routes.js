...
//        .get(questionPaperController.emitEvent);
    ...
    /**
     * Publish bulk questions based on tags
     */
    app.route('/api/question/publish/bulk')
        .post(middleware.adminAuth,question.bulkUpdateQuestions);
...
//        .get(middleware.auth,questionPaperController.getSamplePaperByTag);
    ...
    app.route('/api/questionPaper/category/papers')
        .get(middleware.auth,questionPaperController.getByCategory);

    app.route('/api/questionPaper/category/papers/sample')
        .get(questionPaperController.getSampleQuizzesByCategory);

    app.route('/api/questionPaper/category/:category/score/summary')
        .get(middleware.adminAuth,questionPaperController.getScoreSummary);
    ...
    /**
     * Bulk publish papers with tags
     */
    app.route('/api/questionPaper/publish/all/tags')
        .put(middleware.adminAuth,questionPaperController.publishPapersByCategory);
