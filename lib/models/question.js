...
var SectionSchema = new Schema({
    ...
    passKey: [String],      //Pass Keys to be generated
...
var QuestionPaperSchema = new Schema({
    ...
    creationDate: Date,   //In case of paper creation date when question paper was set...In case of answer sheet when it was submitted by candidate
    ...
    passKey : {type: String, index: true, unique:true},
