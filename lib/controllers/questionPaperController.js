...
exports.getByCategory = function (req, res, next) {
    ...
    paperQuery.select('id name').exec(function(err,data){
        if (err) {
            ...
            getScoreSummary(req.session.userInfo.email,paperIdArr,function(err,data){
...
exports.createSamplePaperForTag = function (paperName,categories, email,sectionName,questionIds,callback) {
